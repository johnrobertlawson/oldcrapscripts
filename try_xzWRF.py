...
# xswidthkm denotes approx km either side of the focus point
# xsangle denotes which compass point the left-side of the plot points to
# e.g. NW to SE plot will be 'NW'. 
def xzCloudPlot(nest,datetuple,xswidthkm,xsangle,plotTemp=False,plotRH=False,plotTheta=True):
    nc = openWRF(nest)
    ...
    # Work out x-section width in grid points assuming square boxes
    #xswidth = xswidthkm / _dx
    # Create x-axis of 
    # Need to edit _getHeight function later on
    ...
    #plt.show()
    plt.savefig(outdir+naming+str(nest)+'_xsection.png')
    plt.close()        
